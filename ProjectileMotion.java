...
public class ProjectileMotion{
  ...
  public static void main(String[] args){
    ProjectileMotion pm1 = new ProjectileMotion();
    ProjectileMotion pm2 = new ProjectileMotion(55,45,200,10);
    pm1.table();
  }
  
  /*
   * constructor to calculate PM data bsed on users input
   */
  ...
  /*
   * constructor to calculate PM data bsed on the provided input
   */
