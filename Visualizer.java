...
//             }
            g.setColor(Color.black);
            for(int i = 0; i < this.buildings.size(); i += 4) {
               g.fillRect(this.buildings.get(i), this.buildings.get(i+1), this.buildings.get(i+2), this.buildings.get(i+3));
            }
        }
    }
    
    // private class DrawBuildings extends JComponent {
//       List<Building> listBuildings;
//       
//       public DrawBuildings(int width, int height) {
//          listBuildings = (new Levels(width, height)).getBuildings();
//       }
//       
//       public void paint(Graphics g) {
//             Graphics2D arc = (Graphics2D)g;
...
//                g.drawRect(b.getCenter() - b.getRadius(), 0, b.getWidth(), b.getHeight());
//             }
//         }
//     }
